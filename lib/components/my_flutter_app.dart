...
class MyFlutterApp {
  ...
  static const IconData dinner_plate__1_ = IconData(0xe802, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData user_circle = IconData(0xe803, fontFamily: _kFontFam, fontPackage: _kFontPkg);
}
